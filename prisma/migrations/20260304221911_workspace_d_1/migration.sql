...
-- CreateEnum
CREATE TYPE "AuditAction" AS ENUM ('MEMBER_JOINED', 'MEMBER_LEFT', 'MEMBER_ROLE_CHANGED', 'INVITE_SENT', 'INVITE_ACCEPTED', 'INVITE_REVOKED', 'WORKSPACE_UPDATED', 'OWNERSHIP_TRANSFERRED');
...
-- CreateIndex
CREATE UNIQUE INDEX "Invitation_email_workspaceId_status_key" ON "Invitation"("email", "workspaceId", "status");
